...
function getIcon(isFile: boolean, fileExtension: string): React.ReactNode {
  ...
  if (notes.includes(fileExtension)) return ICONS.note;
  if (bookmarks.includes(fileExtension)) return ICONS.bookmark;
  if (emails.includes(fileExtension)) return ICONS.email;
  if (ebooks.includes(fileExtension)) return ICONS.ebook;
