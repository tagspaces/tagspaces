    ...
    openEntry: e => {
      ...
      /* if (lastSelectedEntry) {
        if (lastSelectedEntry.isFile) {
          props.openFsEntry(lastSelectedEntry);
        } else {
          props.loadDirectoryContent(lastSelectedEntry.path); // lastSelectedEntryPath);
        }
      } */
    },
    openFileExternally: () => {
      ...
      if (lastSelectedEntry) {
        if (lastSelectedEntry.isFile) {
          props.openFileNatively(lastSelectedEntry.path);
        }
      } */
    }
  };
